...
public class AcceptanceController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAllAcceptances(int index = 1, int pageSize = 10, int idSearch = 0, string nameSearch = "", int facultyAcceptedStatus = 3, int acceptedForPublicationStatus = 3, int competitionId = 0, int facultyId = 0,int accountId = 0)
    {
        var result = await _acceptanceService.GetAllAcceptances(index, pageSize, idSearch, nameSearch, facultyAcceptedStatus, acceptedForPublicationStatus, competitionId, facultyId,accountId);
