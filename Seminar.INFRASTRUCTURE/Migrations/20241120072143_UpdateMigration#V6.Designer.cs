...
namespace Seminar.INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20241120072143_UpdateMigration#V6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Competition", b =>
                {
                    ...
                    b.Property<DateTime?>("DateEndSubmit")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Review_Acceptance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Review_Acceptances");
                });

            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Review_Board_Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.ResearchTopic", b =>
                {
                    ...
                    b.HasOne("Seminar.DOMAIN.Entitys.Review_Committee", "Review_Committees")
                        .WithMany("ResearchTopics")
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Review_Acceptance", b =>
                {
                    b.HasOne("Seminar.DOMAIN.Entitys.Acceptance", "Acceptance")
                        .WithMany("Review_Acceptances")
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Review_Board_Member", b =>
                {
                    b.HasOne("Seminar.DOMAIN.Entitys.Review_Committee", "ReviewCommittee")
                        .WithMany("Review_Board_Members")
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Acceptance", b =>
                {
                    b.Navigation("Review_Acceptances");
                });
            ...
            modelBuilder.Entity("Seminar.DOMAIN.Entitys.Review_Committee", b =>
                {
                    ...
                    b.Navigation("Review_Board_Members");
                });
