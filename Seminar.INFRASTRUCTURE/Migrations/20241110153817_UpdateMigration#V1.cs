        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateEndSubmit = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    CompetitionId = table.Column<int>(type: "int", nullable: false),
                    Review_CommitteeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResearchTopics_Review_Committees_Review_CommitteeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAcceptance = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FinalFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsFacultyAccepted = table.Column<bool>(type: "bit", nullable: false),
                    IsAcceptedForPublication = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchTopics_Review_CommitteeId",
                table: "ResearchTopics",
